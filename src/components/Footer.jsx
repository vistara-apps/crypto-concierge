      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Crypto Concierge</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-md">
              The one-stop shop for seamless, cross-chain crypto payments. 
              Accept any cryptocurrency across multiple blockchains with a single API.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 mb-8">
          <div className="max-w-md">
            ...
            <p className="text-gray-400 mb-4">
              Get the latest updates on new features, cryptocurrencies, and integrations.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Crypto Concierge. All rights reserved.
          </p>
